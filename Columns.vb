...
Public Module GridColumns
    ...
    Public Sub BuildMonitorColumns(dgv As DataGridView)
        ...
        AddText(dgv, "Bid", "Bid", width:=110, align:=DataGridViewContentAlignment.MiddleRight)
        AddText(dgv, "Ask", "Ask", width:=110, align:=DataGridViewContentAlignment.MiddleRight)
        AddText(dgv, "Last", "Last", width:=110, align:=DataGridViewContentAlignment.MiddleRight)
